...
namespace ApiTiendaDonPepe.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        public ProveedoresController(IProveedoresRepository repo) => _repo = repo;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Proveedores p)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Proveedores p)
        {
            p.Id = id;
